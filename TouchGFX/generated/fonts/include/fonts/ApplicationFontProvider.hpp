...
{
    static const touchgfx::FontId DEFAULT = 0; // ariblk_20_4bpp
    static const touchgfx::FontId LARGE = 1;   // phagspab_49_4bpp
    static const touchgfx::FontId SMALL = 2;   // ariali_16_4bpp
