...
extern touchgfx::GeneratedFont& getFont_phagspab_49_4bpp();
extern touchgfx::GeneratedFont& getFont_ariali_16_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_ariblk_20_4bpp()),
    &(getFont_phagspab_49_4bpp()),
    &(getFont_ariali_16_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_ariblk_20_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_phagspab_49_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_ariali_16_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
